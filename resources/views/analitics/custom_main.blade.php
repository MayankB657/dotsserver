...
<script>
    $(document).ready(function() {
        ...
        function fetchGraphData() {
            const url = @json(route('custom.graph.view'));
            $.ajax({
                url: url,
                method: 'GET',
                success: function(response) {
        ...
        function removeGraph() {
            const url = @json(route('remove.custom.graph'));
            $.ajax({
                url: url,
                method: 'GET',
                success: function(response) {
        ...
        function addGraph() {
            let activityGroupId = null,
                activityTypeId = null,
                graphType = null,
                activityGroupIdOne = null,
                activityTypeIdOne = null,
                graphTypeOne = null,
                dateType = null,
                flag = null,
                startDate = null,
            ...
            const url = @json(route('add.custom.graph'));
        ...
        function updateGraph(filterRow) {
            ...
            if (filterRow) {
                ...
                activityGroupIdOne = $(`.actGroupDropdownOne[data-row="${filterRow}"]`).val();
                activityTypeIdOne = $(`.actTypeDropdownOne[data-row="${filterRow}"]`).val();
                graphTypeOne = $(`.graphTypeDropdownOne[data-row="${filterRow}"]`).val();
            ...
            const url = @json(route('update.custom.graph'));
        ...
        $(document).on('click', '#graph-container .close-graph', function(e) {
            ...
            fetch(`delete-custom-graph/${graphId}`, {
                    method: 'DELETE',
                    headers: {
